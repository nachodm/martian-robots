# My solution to the martian-robots challenge
Interview code challenge for Guidesmiths

It is necessary to run npm install before starting in order to install all the dependencies.

You can use either `npm start` or directly `node app.js` to run the application. 
...
Testing can be run using either `npm test`or directly `mocha`.
## Martian robots
